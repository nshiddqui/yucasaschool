...
class Type extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
		...
		$this->data['page_title'] = 'Certificates Type';
        $this->data['folder'] = 'certificate/type';
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($updated) {
                    ...
                    redirect('type/edit/' . $this->input->post('id'));
                }
            } else {
    ...
    * ********************************************************** */
    private function _prepare_type_validation() {
        ...
        $this->form_validation->set_rules('background', $this->lang->line('background'), 'trim');
    }
