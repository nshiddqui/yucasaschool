<?php
    ...
    $added_question_info = $this->db->get_where('scholarship_question_bank', array('online_exam_id' => $online_exam_id))->result_array();
?>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div id="print_options">
            <a href="<?php echo site_url('admin/scholarship_exam_questions_print_view/'.$online_exam_id.'/answers');?>" class="btn btn-white pull-right" id="questions_print_with_answers">
                <i class="entypo-print"></i> &nbsp; <?php echo get_phrase('print_with_answers');?>
            </a>
            <a href="<?php echo site_url('admin/scholarship_exam_questions_print_view/'.$online_exam_id.'/no_answers');?>" class="btn btn-white pull-right" id="questions_print_without_answers">
                            ...
                            foreach ($added_question_info as $added_question): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/scholarship_update_online_exam_question/'.$added_question['question_bank_id']);?>')" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo get_phrase('edit'); ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        <a href = "#" onclick="confirm_modal('<?php echo site_url('admin/scholarship_delete_question_from_online_exam/'.$added_question['question_bank_id']);?>');" class = "btn btn-danger btn-xs"  data-toggle="tooltip" title="<?php echo get_phrase('delete'); ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#question_type').on('change', function() {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/load_question_type/');?>' + question_type + '/' + online_exam_id +'/' +'scholarship_manage_online_exam_question'
