<?php
    $online_exam_details = $this->db->get_where('online_exam', array('online_exam_id' => 2))->row_array();
    ...
    $total_mark          = $this->crud_model->get_total_mark(2);
?>
   ...
   <div class="page-header">
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li class="active">Online Exam Results</li>
