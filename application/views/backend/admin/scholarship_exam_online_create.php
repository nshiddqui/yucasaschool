   ...
   <div class="page-header">
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li class="active">Create Online Exams</li>
...
<div class="row">
    <?php echo form_open(site_url('admin/scholarship_exam_online_manage/create') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
        <div class="col-md-6">
