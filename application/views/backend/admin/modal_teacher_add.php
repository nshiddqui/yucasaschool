	...
	<div class="col-md-12">
      ...
      <?php echo form_open(site_url('admin/teacher/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="radio" class="form-control" name="is_class_teacher" value="1"  data-validate="required"/>Yes<br>
                                     <input type="radio" class="form-control" name="is_class_teacher" value="0"  data-validate="required"/>No<br>
                                </div>
                            </div>
                            <div class="form-group">
