	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/exam/edit/do_update/'.$row['exam_id'] ), array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            <div class="padded">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="datepicker form-control" name="deadline" value="<?php echo $row['deadline'];?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('marks_/_grade_submission');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="datepicker form-control" name="marks_submission" value="<?php echo $row['marks_submission'];?>"/>
                                </div>
                            </div>
                <div class="form-group">
