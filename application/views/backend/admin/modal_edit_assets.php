<?php
$edit_data		=	$this->db->get_where('asset' , array('asset_id' => $param2) )->result_array();
...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open(site_url('admin/add_asset/do_update/'.$row['asset_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            <div class="padded">
                ...
                <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" class="form-control" name="number_of_asset" data-validate="required" value="<?php echo $row['number_asset'];?>" data-message-required="<?php echo get_phrase('value_required');?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="asset_category" class="form-control" required>
                              ...
                              <?php
                                ...
                                foreach($asset as $row1):
                                    ?>
                                    <option value="<?php echo $row1['asset_category_id'];?>" <?=$row['category'] == $row1['asset_category_id']?'selected':'';?> >
