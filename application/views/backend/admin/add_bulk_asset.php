   ...
   <div class="page-header">
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li class="active">Add Bulk Assets</li>
...
<?php echo form_open(site_url('admin/add_bulk_assets/import') ,
...
<ul class="list-btn">
	<li>
		<button type="button" class="btn btn-primary" > <a href="<?php echo base_url()?>uploads/document/add_bulk_assets.csv" download style="
    color: white;
