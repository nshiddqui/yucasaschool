        ...
        <?php
            ...
            if(sizeof($subjects) > 0):
        	  foreach($subjects as $row):
               $teachername =  $this->db->get_where('teacher',array('teacher_id'=>$row['teacher_id']))->row()->name;
         ?>
    	  <option value="<?php echo $row['subject_id'];?>"><?php echo $row['name'];?>
               &nbsp;&nbsp;[ <?php echo $teachername;?> ]</option>
    	    <?php endforeach;
                   endif;?>
        </select>
    </div>
