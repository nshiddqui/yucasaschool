                   ...
                   <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        ?>
						  ...
						  <?php  $assignment_status	=$this->db->get_where('settings' , array('type'=>'assignment_status'))->row()->description; ?>
						    <?php if($assignment_status==1){ ?>
							
							
							<tr>
                                <td style="text-align: center;">Assignment</td>
                                 <td style="text-align: center;">
                         <?php  echo $assignment_weightage	=$this->db->get_where('settings' , array('type'=>'assignment_weightage'))->row()->description; ?>
                                  
                                </td>
                                <td style="text-align: center;">
                <?php  
     $pre_student_reg=$this->db->get_where('settings' , array('type'=>'registration_fees'))->row()->description;   
     $number_of_student_in_current_session = $this->db->get_where('pre_enroll', array('year' => $running_year))->num_rows();
     $due_fee=$pre_student_reg * $number_of_student_in_current_session;
      $query = $this->db->query('SELECT sum(assignment_marks) FROM  assignments')->result_array();
...
<?php
    endforeach;
        ...
        echo '<h2 style="text-align: center;">There is no data to show here</h2>';
    }
        endforeach;
?>