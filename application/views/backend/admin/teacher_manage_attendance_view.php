                    ...
                    foreach ($attendance_of_teacher as $row):
                        ...
                        <tr>
                            ...
                            <td>
							 ...
							 <td>
                                <select class="form-control" name="outstatus_<?php echo $row['attendance_id']; ?>" id="outstatus_<?php echo $select_id; ?>">
                                    <option value="0" <?php if ($row['out_status'] == 0) echo 'selected'; ?>><?php echo get_phrase('in_time'); ?></option>
                                    <option value="1" <?php if ($row['out_status'] == 1) echo 'selected'; ?>><?php echo get_phrase('Out_time'); ?></option>
                                   
                                </select>


                            </td>
                            <td><div ><input type="text" class="form-control att_time" name="time[]"></div></td>
