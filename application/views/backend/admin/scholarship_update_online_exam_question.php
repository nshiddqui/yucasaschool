<?php
    $question_details = $this->db->get_where('scholarship_question_bank', array('question_bank_id' => $param2))->row_array();
    ...
    $online_exam_details = $this->db->get_where('scholarship_question_bank', array('online_exam_id' => $question_details['online_exam_id']))->row_array();

    $added_question_info = $this->db->get_where('scholarship_question_bank', array('online_exam_id' => $online_exam_details['online_exam_id']))->result_array();
...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open(site_url('admin/scholarship_update_online_exam_question/'.$param2.'/update'.'/'.$question_details['online_exam_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
