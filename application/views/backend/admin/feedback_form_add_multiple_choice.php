<?php
if($formurl != "" && $formurl != "teacher_feedback_manage_question")
  $formurl = 'teacher_feedback_manage_question'; 


 echo form_open(site_url('admin/teacher_feedback_manage_question/'.$form_id.'/add/multiple_choice') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
...
<div class="form-group" id='multiple_choice_question'>
    <label class="col-sm-3 control-label"><?php echo get_phrase('star_rating');?></label>
