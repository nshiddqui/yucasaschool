            ...
            <div class="report__card__school__info">
                <div class="flex">
                    ...
                    <div class="report__card__school__info__center">
                        ...
                        <div class="academic__session">
                                <strong>Report Card For Class <?php echo $class_name ?></strong></span>
                            </div>
                                    ...
                                    <div class="flex">
                                       ...
                                       ?> 
                                        <div class="subject__competencies__details">
                                            <div class="subject__competencies__heading"><?php echo $row5[name];?></div>
                                            <div class="subject__mark__box bg__light__blue">
                                                <p><?php echo $row5[marks];?></p>
                                            </div>
                                                 <?php 
                                                    	foreach($exams as $rowts){
                                                     $subject_marks = $this->db->get_where('mark',array('subject_id'=> $rowts[subject_id],'student_id'=>$student_id))->result_array();
				                	    
				                	                foreach($subject_marks as $row5mark){ ?>
                                                    <div class="subject_grade"><?php echo $this->db->get_where('cat_mark',array('competencies_name'=>$row5['name'],'mark_id'=>$row5mark['mark_id']))->row()->competencies_marks;?></div>
                                        ...
                                        <div class="subject__competencies__details">
                                            ...
                                            <?php 
                                             foreach($exams as $rowts){
                                             $subject_marks = $this->db->get_where('mark',array('subject_id'=> $rowts[subject_id],'student_id'=>$student_id))->row()->mark_obtained;
				                	        ?>
				                	               
                                                    <div class="subject_grade"><?php echo $subject_marks ;?></div>
                                            ...
                                            <div class="subject__mark__box bg__light__blue">
                                                <p>100</p>
                                                   ...
                                                   <?php 
				                	                ...
				                	                foreach($subject_marks as $row5mark){ 
				                	                $mark_obtained=$row5mark[mark_obtained]; ?>
                                                    <div class="subject_grade"><?php  $total= $this->db->query("SELECT SUM(competencies_marks) as mark FROM cat_mark WHERE mark_id=$row5mark[mark_id]")->row()->mark;
                                                    echo $mark_obtained +$total;
                                                    ?></div>
             ...
             <div class="report__card__extracurricular__marks">
                    ...
                    <div class="flex">
                        ...
                        <div class="co__scholatic__area co__scholatic__area__left">
                          ...
                          <?php
                          echo $class_id;
                                 $co_sub=  $this->db->get_where('co_scholastic_subject', array('class_id'=>$class_id))->result_array();
                              	foreach($co_sub as $rows512){
                                ?>
                                <div class="flex">
                                    <div class="co__sholastic__item">
                                        <h6><?php echo $rows512[sub_name];?></h6>
                                    </div>
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Report Card Template class 11</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    <style>
        .report__card__wrapper{
            width: 90%;
    ...
    <div class="report__card__wrapper">
                    ...
                    <div class="report__card__student__info ">
                        <div class="report__card__student__info__box">
                            <div class="flex flex__100">
                                ...
                                <div class="admission_number">
                                    <p><strong>Registration No : </strong> <?php echo $student_code ?></p>
                                </div>
                                ...
                                <div class="exam__term__wrapper">
                                    <div class="flex">
                                        ...
                                        <div class="exam__cycle__wrapper">
                                            ...
                                            $exams = $this->db->query("SELECT t1.name, t1.subject_id FROM subject t1 LEFT JOIN subject_practial t2 ON t2.subject_id = t1.subject_id WHERE t2.subject_id IS NULL AND t1.class_id=$class_id")->result_array();
                                    ...
                                    <div class="subject__information">
                                       ...
                                       ?> 
                                                <div class="subject__competencies__details">
                                                    <div class="subject__competencies__heading"><?php echo $row5[name]; ?></div>
                                                    <div class="subject__mark__box bg__light__blue">
                                                        <p> <?php echo $waitage=$row5[weightage];?> </p>
                                                    </div>
                                                    <?php $i=0;
                                                    	foreach($exams as $rowts){
                                                    	    $arr_final[$i]=array();
				                	                ...
				                	                foreach($subject_marks as $row5mark){ ?>
                                                    <div class="subject_grade"><?php
                                                    
                                                    $markst= $this->db->get_where('cat_mark',array('competencies_name'=>$row5['name'],'mark_id'=>$row5mark['mark_id']))->row()->competencies_marks;
                                                   echo  $toatl=($markst*$waitage)/100;
                                           ...
                                           <?php $arr_final=array(); $k=0;	foreach($subject_competencies as $row5){?>
                                           <?php $arr_final[$k]=array();  $waitage=$row5[weightage];?>
		...
		$j=0;
                                           ...
                                           <?php
                                                     ...
                                                     $markst= $this->db->get_where('cat_mark',array('competencies_name'=>$row5['name'],'mark_id'=>$row5mark['mark_id']))->row()->competencies_marks;
                                                     $toatl=($markst*$waitage)/100;
                                                    array_push($arr_final[$k][$i],$toatl);
                                                    ?>
                                           <?php $j++;} ?>
                                           ...
                                           <?php $final=array();
                                           for($l=0;$l<count($arr_final);$l++){
                                               for($m=0;$m<count($arr_final[$l]);$m++){
                                                   if($l==0){
                                                       $final[$m]=array();
                                                       array_push($final[$m],$arr_final[$l][$m][0]);
                                                   }else{
                                                       array_push($final[$m],$arr_final[$l][$m][0]);
                                                   }
                                               }
                                           ...
                                           ?>
                                                <div class="subject__competencies__details grand__total">
                                                  ...
                                                  <?php $final_to_sum=array(); for($n=0;$n<count($final);$n++){?>
                                                   <div class="subject_grade bg__light__yellow"><?php echo $ear=array_sum($final[$n]);
                                                   array_push($final_to_sum,$ear);
                                                   ?></div>
                                                      <?php } ?>   
                                                </div>
                            ...
                            <div class="flex">
                                <div class="report__card__exam__marks__left text__uppercase width__15">
                                    ...
                                    <div class="exam__term__wrapper">
                                        <div class="flex">
                                            ...
                                            <div class="exam__cycle__wrapper">
                                                 <?php  
                                            $examss = $this->db->query("SELECT t1.name as practical_name,t2.subject_id, t2.name as subject FROM subject_practial  t1 LEFT JOIN subject t2 ON t2.subject_id = t1.subject_id WHERE t2.class_id=$class_id")->result_array();
				                        
				                         	foreach($examss as $rows){
                                             ?>
                                                <div class="exam__cycle">
                                                    <strong><?php echo $rows[subject]?></strong>
                                                </div>
                                                <?php } ?>
                                ...
                                <div class="report__card__exam__marks__header text__uppercase" style="max-width:25%;"> 
                                    <div class="flex ">
                                        ...
                                        $subject_practicle = $this->db->get_where('subject_competencies' , array('subject_id' => $rows[subject_id]))->result_array();
                                        //print_r($subject_competencies);
				                       	foreach($subject_practicle as $rows5){
                                       ?> 
                                                    <div class="subject__competencies__details">
                                                        <div class="subject__competencies__heading"><?php echo $rows5[name];?></div>
                                                        <div class="subject__mark__box bg__light__blue">
                                                            <p><?php echo $rows5[marks];?></p>
                                                        </div>
                                                        
                                                        
                                                       <?php 
                                                       foreach($examss as $rowstd){
                                                     $subject_marksP = $this->db->get_where('mark',array('subject_id'=> $rowstd[subject_id],'student_id'=>$student_id))->result_array();
				                	    
				                	                foreach($subject_marksP as $row5markp){ ?>
                                                    <div class="subject_grade"><?php echo $this->db->get_where('cat_mark',array('competencies_name'=>$rows5['name'],'mark_id'=>$row5markp['mark_id']))->row()->competencies_marks;?></div>
                                       ...
                                       <?php } ?>
                                        ...
                                        $subject_practial = $this->db->get_where('subject_practial' , array('subject_id' => $rows[subject_id]))->result_array();
                                        //print_r($subject_competencies);
				                       	foreach($subject_practial as $rows51){
                                       ?> 
                                                    <!--<div class="subject__competencies__details">
                                                        <div class="subject__competencies__heading"><?php echo $rows51[name];?></div>
                                                        <div class="subject__mark__box bg__light__blue">
                                                            <p><?php echo $rows51[marks];?></p>
                                                        </div>
                                                       
                                                        <?php 
                                                       foreach($examss as $rowstd){
                                                     $subject_marksPD = $this->db->get_where('mark',array('subject_id'=> $rowstd[subject_id],'student_id'=>$student_id))->result_array();
				                	    
				                	                foreach($subject_marksPD as $row5markpD){ ?>
                                                    <div class="subject_grade"><?php echo $this->db->get_where('cat_mark',array('competencies_name'=>$rows51['name'],'mark_id'=>$row5markpD['mark_id']))->row()->competencies_marks;?></div>
                                    ...
                                    <div class="flex ">
                                       ...
                                       ?> 
                                                    <div class="subject__competencies__details">
                                                        <div class="subject__competencies__heading"><?php echo $rows5[name];?></div>
                                                        <div class="subject__mark__box bg__light__blue">
                                                            <p><?php echo $waitage=$rows5[weightage];?></p>
                                                        </div>
                                                    ...
                                                    <div class="subject_grade">
                                                        ...
                                                        <?php
                                                         $markst=$this->db->get_where('cat_mark',array('competencies_name'=>$rows5['name'],'mark_id'=>$row5markp['mark_id']))->row()->competencies_marks;
                                                       echo $toatl=($markst*$waitage)/100;
                                                        ?></div>
                                       ...
                                       <?php $arr_final_pras=array(); $k=0;	
                                        $subject_practicless = $this->db->get_where('subject_competencies' , array('subject_id' => $rows['subject_id']))->result_array();
                                       foreach($subject_practicless as $row59){?>
                                           <?php $arr_final_pras[$k]=array();  $waitages=$row59[weightage];?>
                                           
                                                       <?php  $i=0;
                                                    	foreach($examss as $rowtsd){ 
                                                   $arr_final_pras[$k][$i]=array();
                                                     $subject_marksPs = $this->db->get_where('mark',array('subject_id'=> $rowtsd['subject_id'],'student_id'=>$student_id))->result_array();
	                                                 	$j=0;
				                	                foreach($subject_marksPs as $row5markps){ ?>
                                           <?php
                                                      
                                                    $marksts=$this->db->get_where('cat_mark',array('competencies_name'=>$row59['name'],'mark_id'=>$row5markps['mark_id']))->row()->competencies_marks;
                                                     $toatls=($marksts*$waitages)/100;
                                                    array_push($arr_final_pras[$k][$i],$toatls);
                                                    ?>
                                           <?php $j++;} ?>
                                           ...
                                           <?php $final_pra=array();
                                           for($l=0;$l<count($arr_final_pras);$l++){
                                               for($m=0;$m<count($arr_final_pras[$l]);$m++){
                                                   if($l==0){
                                                       $final_pra[$m]=array();
                                                       array_push($final_pra[$m],$arr_final_pras[$l][$m][0]);
                                                   }else{
                                                       array_push($final_pra[$m],$arr_final_pras[$l][$m][0]);
                                                   }
                                               }
                                           ...
                                           ?>
                                                    ...
                                                    <div class="subject__competencies__details">
                                                        ...
                                                        <?php for($n=0;$n<count($final_pra);$n++){?>
                                                   <div class="subject_grade bg__light__yellow"><?php echo array_sum($final_pra[$n]);?></div>
                                                      <?php } ?> 
                                       ...
                                       ?> 
				                	                ...
				                	                foreach($subject_marksPD as $row5markpD){ ?>
                                                    <div class="subject_grade">
                                                        <?php echo $parctical=$this->db->get_where('cat_mark',array('competencies_name'=>$rows51['name'],'mark_id'=>$row5markpD['mark_id']))->row()->competencies_marks;
                                                        array_push($arr_prac,$parctical);  ?></div>
                                       ...
                                       <?php } ?>
                                                    ...
                                                    <div class="subject__competencies__details grand__total">
                                                        ...
                                                        <?php 
                                                        $final_sum_pra=array();
                                                        for($n=0;$n<count($final_pra);$n++){?>
                                                        <?php  $finalto=array_sum($final_pra[$n]);?>
                                                      
                                                   
                                                      <div class="subject_grade bg__light__yellow"><?php  echo $f=$finalto+$arr_prac[$n];
                                                      array_push($final_sum_pra,$f);
                                                      ?> </div>
                                                      <?php } ?> 
                    ...
                    <div class="mark__final__info">
                        <div class="flex" >
                            ...
                            <div class="mark__final__info__item">
                                MAXIMUM MARKS = <span><?php echo $pre_ma=(sizeof($final)+sizeof($final_pra))*100;?></span>
                            </div>

                            <div class="mark__final__info__item">
                                MARKS OBTAINED = <span><?php 
                                $pre=array_sum($final_to_sum)+array_sum($final_sum_pra);
                                //echo array_sum($final)+array_sum($final_pra);
                                echo $pre;
                                ?></span>
                            </div>

                            <div class="mark__final__info__item">
                                PERCENTAGE = <span><?php $parcent= ($pre/$pre_ma)*100;         
                                echo number_format($parcent, 2); 
                                ?>
                                </span>
                            </div>
...
<h1 style="
    ...
    font-size: 25px;
    color: red;
">Please select School Register Board</h1>
