...
if($formurl != "" && $formurl != "scholarship_manage_online_exam_question")
  $formurl = 'pre_manage_online_exam_question'; 
elseif($formurl == "scholarship_manage_online_exam_question")
  $formurl = 'scholarship_manage_online_exam_question'; 
else  
 $formurl  = 'manage_online_exam_question';


echo form_open(site_url('admin/'.$formurl.'/'.$online_exam_id.'/add/fill_in_the_blanks') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
