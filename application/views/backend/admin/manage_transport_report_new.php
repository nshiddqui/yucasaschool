	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
            	...
            	<div class="panel-title">
					...
					<?php
            		    if(!empty($_GET['title'])){
            		        ...
            		        echo get_phrase('download_inventory_excel');
            		        $getUrl = '';
            		    }
            		?>
            	</div>
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/transport_school_excel'.$getUrl) , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
				 ...
				 -->
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" onclick="select_section_report1();" class="btn btn-info"><?php echo get_phrase('submit');?></button>
						</div>
					</div>
...
<script>
        function select_section_report() {
            var month=$('#inv_month').val();
            var year=$('#inv_year').val();
            var type_id=$('#room_type').val();
    if (month !== '' && year !== '') {
    //c_id = class_id;
    var myKeyVals = { 'month' : month, 'sessional_year' : year }
...
format: 'yyyy-mm-dd', todayHighlight:'TRUE', endDate: '-0d', autoclose: true,
    });
