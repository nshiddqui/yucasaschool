<?php
    $online_exam = $this->db->get_where('scholarship_online_exam', array('online_exam_id' => $online_exam_id))->row_array();
...
<div class="row">
    <?php echo form_open(site_url('admin/scholarship_exam_online_manage/edit') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
