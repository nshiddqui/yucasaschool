   ...
   <div class="page-header">
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li class="active">Income Head</li>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                            ...
                                            <td>                                                
                                                ...
                                                <?php } ?> -->
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        ...
                                                        <li>
                                                          <?php if(has_permission(EDIT, 'accounting', 'incomehead')){ ?>
                                                            <a href="<?php echo site_url('incomehead/edit/'.$obj->id); ?>" class=""><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        </li>
                                                        ...
                                                        <li>
                                                           <?php if(has_permission(DELETE, 'accounting', 'incomehead')){ ?>
                                                            <a href="<?php echo site_url('incomehead/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class=""><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                        <?php } ?>
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_incomehead">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('incomehead/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_incomehead">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('incomehead/edit/'.$incomehead->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <a href="<?php echo site_url('accounting/incomehead'); ?>"  class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
