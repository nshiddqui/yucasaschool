                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'certificate', 'type')){ ?>
                                                    <a href="<?php echo site_url('type/view/'.$obj->id); ?>" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(EDIT, 'certificate', 'type')){ ?>
                                                    <a href="<?php echo site_url('type/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'certificate', 'type')){ ?>
                                                    <a href="<?php echo site_url('type/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_type">
                            <div class="x_content"> 
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <?php echo form_open_multipart(site_url('type/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="item form-group">
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             ...
                                             <div class="text-info" style="float:right;">jpeg,jpg [1300x700]</div>
                                     ...
                                     <div class="form-group">
                                         <div class="col-md-6 col-md-offset-3">
                                             <a  href="<?php echo site_url('type'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                                             <button id="send" type="submit" class="btn btn-info pull-right"><?php echo $this->lang->line('submit'); ?></button>
                                         </div>
                                     </div>
                                     <?php echo form_close(); ?>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 bg-white">
                                    <h3>NOTE: Use this fields name for placing dynamic values of student.</h3>
                                    <p>[name]</p>
                                    <p>[email]</p>
                                    <p>[phone]</p>
                                    <p>[class_name]</p>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_type">
                            <div class="x_content"> 
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <?php echo form_open_multipart(site_url('type/edit/'.$certificate->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="item form-group">
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="main_text"> <?php echo $this->lang->line('main_certificate_text'); ?> <span class="required">*</span></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <textarea  class="form-control col-md-7 col-xs-12"  name="main_text"  id="edit_main_text" required="required" placeholder="<?php echo $this->lang->line('main_certificate_text'); ?>"><?php echo isset($certificate) ? $certificate->main_text : $main_text; ?></textarea>
                                             <div class="help-block"><?php echo form_error('main_text'); ?></div>
                                             <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="fn_add_tag"></div>
                                            </div>
                        ...
                        <?php if(isset($detail)){ ?>
                             <div class="tab-pane fade in active" id="tab_view_type">
                                <div class="x_content"> 
                                <?php echo form_open_multipart(site_url('type/view/'. $certificate->id), array('name' => '', 'id' => '', 'class'=>'form-horizontal form-label-left'), ''); ?>
