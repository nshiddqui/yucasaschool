            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active " id="tab_guardian_list" >
                            <div class="x_content">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($guardians) && !empty($guardians)){ ?>
										...
										?>
										<?php if ($created_by==$parent_id || $role_id==8 ){?>
                                        <tr>
                                                ...
                                                <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        ...
                                                        <?php if(has_permission(EDIT, 'guardian', 'guardian')){ ?>
                                                            <a href="<?php echo site_url('parent/parent_edit/'.$obj->id); ?>" ><i class="entypo-pencil"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        </li>
                                                        ...
                                                        <?php if(has_permission(VIEW, 'guardian', 'guardian')){ ?>
                                                            <!--<a  onclick="get_guardian_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-guardian-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?></a>-->
                                                             ...
                                                             <a  onclick='showAjaxModal("<?php echo site_url('modal/popup/get-single-guardian/'.$obj->id);?>");'  ><i class="fa fa-eye"></i>&nbsp; <?php echo $this->lang->line('view'); ?> </a>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_guardian">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('parents/guardian_list_add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="role_id"  id="role_id" value="8" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="hidden">
                                   ...
                                   <div class="col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="relation" id="relation" value="" placeholder="Relation" required="required" type="text">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="religion"  id="religion" value="<?php echo isset($guardian->religion) ?  $guardian->religion : ''; ?>" placeholder="<?php echo $this->lang->line('religion'); ?>" type="text">
                                            <div class="help-block"><?php echo form_error('religion'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
