<style>
    body.style-light .panel-primary > .panel-heading {
        background: #2f4a65!important;
    }
...
<?php include base_path().'application/views/backend/navigation_tab/parents/parent_nav_tab.php'; ?> 
<!-- Including Navigation Tab -->
</div>
...
<div class="facebook_album_gallery">
    ...
    <div class="facebook_album_gallery_slider">
       <?php
    ...
    <div class="modal-dialog"> 
      <div class="modal-content">
        <div class="modal-body">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
            <img src="https://edurama.in/unityerp/assets/images/payment-fee.png"/>
