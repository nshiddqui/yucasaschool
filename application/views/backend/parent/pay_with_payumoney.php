        ...
        <div class="panel-body form-horizontal form-groups-bordered">
          ...
          <form class = "form-horizontal form-groups-bordered" action="<?php echo $action; ?>" method="post" name="payuForm">
              ...
              <div class="form-group" style="display: none;">
                  ...
                  <div class="col-sm-3">
                      <input type = "hidden" name="surl" class="form-control" value="<?php echo site_url('payumoney/on_success'); ?>" size="64" />
                  </div>
              </div>
              <div class="form-group" style="display: none;">
                  <label  class="col-sm-1 control-label"><?php echo get_phrase('Failure_URI:');?></label>
                  <div class="col-sm-3">
                      <input type = "hidden" name="furl" class="form-control" value="<?php echo site_url('payumoney/on_failure'); ?>" size="64" />
                  </div>
              </div>
