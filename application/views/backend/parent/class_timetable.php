                                        ...
                                        <td id = "id<?php echo $k; ?>"  data-day="<?=$j;?>">
                                           ...
                                           // print_r($class_routine_value);
                                            ...
                                            <div class="tt_subject">
                                                ...
                                                <select name="subject_id[<?php echo $i;?>][<?php echo $k;?>]" id="subject<?php echo $i;?><?php echo $k;?>" class="form-control" onchange = "get_teachers_by_subject(this.value,'<?php echo $i;?><?php echo $k;?>','<?php echo $day_;?>','<?php echo $i+1;?>','<?php $timetable_time;?>','<?php $endtime_;?>');">
                                                    <!-- disabled="" -->
