...
<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs bordered">
        ...
        <li class=""><a href="#tab_student_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-male"></i> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
        <li class=""><a href="#tab_invoice_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-dollar"></i> <?php echo $this->lang->line('invoice'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
    </ul>
    <br/>
