   ...
   <div class="page-header">
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li class="active">Due Fee Email</li>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('due_fee'); ?> <?php echo $this->lang->line('email'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>">
                            <a href="#tab_email_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('email'); ?> <?php echo $this->lang->line('list'); ?>
                            </a>
                        </li>

                        <li  class="<?php if(isset($add)){ echo 'active'; }?>">
                            <a href="#tab_add_email"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('send'); ?> <?php echo $this->lang->line('email'); ?>
                            </a>
                        </li>                          
                    </ul>
                    <br/>
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($emails) && !empty($emails)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo @$this->db->get_where($table,array($reciverid => $obj->receivers))->row()->name; ?></td>
                                            <td><?php echo $obj->subject; ?></td>                                           
                                            <td><?php echo get_nice_time($obj->created_at); ?></td>                                           
                                            <td>
                                                <?php if(has_permission(VIEW, 'accounting', 'duefeeemail')){ ?>
                                                  <a  onclick="showAjaxModal('<?php echo site_url('modal/popup/get-single-email/'.$obj->id);?>');" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?></a> 

                                                 <?php } ?>
                                                <?php if(has_permission(DELETE, 'accounting', 'duefeeemail')){ ?>
                                                    <a href="<?php echo site_url('duefeeemail/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                 <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_email">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('duefeeemail/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12"  name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                            ...
                                            <?php foreach($roles_details as $obj ){  ?>
                                                <?php if($obj->id == STUDENT || $obj->id == PARENTT){ ?>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="subject"  id="subject" value="" placeholder="<?php echo $this->lang->line('subject'); ?>" required="required" type="text">
                                ...
                                <div class="ln_solid"></div>
                                  <div class="form-group">
                                      <div class="col-md-6 col-md-offset-3">
                                          <a href="<?php echo site_url('duefeeemail/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
 ...
 <script type="text/javascript">
    ...
    function get_email_modal(email_id){
      $('.fn_email_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('duefeeemail/get_single_email'); ?>",
...
<script type="text/javascript">
  ...
  <?php if(isset($message)){ ?>
    ...
    function get_user_by_role(role_id, user_id){       
       ...
       if(role_id == <?php echo STUDENT; ?> || role_id == <?php echo PARENTT; ?>){
           $('.display').show();
   ...
   function get_user(role_id, class_id, user_id){
      ...
      // alert("<?php echo site_url('/ajax/get_user_by_role'); ?>");
       $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('/ajax/get_student_parent_by_class'); ?>",
