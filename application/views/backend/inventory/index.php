                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <tbody>
                           ...
                           <td><?php echo $inventryAsset[$obj->inventory_type]; ?></td>
                           <td><?php echo $obj->name; ?></td>
                           <td><?php if($obj->status==1){ echo "Active";}else{ echo "Inactive";
                           } ?></td>
                           <!--<td>25</td>
                           <td>In Stock</td>-->
                           <td><a href="<?php echo site_url('inventory/edit/'.$obj->id.'/'); ?>" class="btn btn-info">Edit</a><a href="" class="btn btn-danger">Delete</a></td>
                           </tr>
                           <?php } ?>
                           <?php } ?>
                        </tbody>
