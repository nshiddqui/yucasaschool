            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li  class="<?php if(isset($bulk)){ echo 'active'; }?>"><a href="#tab_bulk_invoice"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="entypo-plus-circled"></i> <?php echo $this->lang->line('create'); ?> <?php echo $this->lang->line('bulk'); ?> <?php echo $this->lang->line('invoice'); ?></a> </li>                          
                        <?php if(isset($edit)){ ?>
 ...
 -->
                                                 <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        ...
                                                        <li>
                                                          <?php if(has_permission(VIEW, 'accounting', 'invoice')){ ?>
                                                            <a href="<?php echo site_url('accountant/invoice_view/'.$obj->id); ?>" class=""><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                        <?php } ?> 
                                                        </li>
                                                        ...
                                                        <li>
                                                           <?php if(has_permission(DELETE, 'accounting', 'invoice')){ ?>
                                                                <?php if($obj->paid_status == 'unpaid'){ ?>
                                                                    <a href="<?php echo site_url('accountant/invoice_delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class=""><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                                <?php } ?>
                                                            <?php } ?>   
                                                        </li>
                                                    </ul>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($single)){ echo 'active'; }?>" id="tab_single_invoice">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accountant/invoice_add'), array('name' => 'single', 'id' => 'single', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <a href="<?php echo site_url('accountant/invoice_list'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($bulk)){ echo 'active'; }?>" id="tab_bulk_invoice">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accountant/invoice_bulk'), array('name' => 'bulk', 'id' => 'bulk', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_tag">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accountant/invoice_edit/'.$invoice->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
