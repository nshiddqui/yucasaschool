                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(DELETE, 'accounting', 'duefeeemail')){ ?>
                                                    <a href="<?php echo site_url('duefeeemail_delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                 <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
 ...
 <script type="text/javascript">
    ...
    function get_email_modal(email_id){
      $('.fn_email_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('accountant/duefeeemail_get_single_email'); ?>",
