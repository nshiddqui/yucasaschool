...
<?php include base_path().'application/views/backend/navigation_tab/accountant/user_leave_nav_tab.php'; ?> 
<!-- Including Navigation Tab -->
</div>
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('accountant/leave_request/create') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
