                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_vehicle_list" >
                            ...
                            <div  class="tab-pane fade in <?php if(isset($liste)){ echo 'active'; }?>" id="tab_vehicle_list" >
                            <div class="x_content">
                            <!--<div class="item form-group">-->
                            <!--        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Choose Date <span class="required">*</span>-->
                            <!--        </label>-->
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php foreach($vehicles as $vehicle){?>
                                   <tr>
                                        ...
                                        <td><?php echo $vehicle->total_cost; ?></td>
                                        <td><?php echo $vehicle->service_date; ?></td>
                                        <td><?php echo $vehicle->next_service_date; ?></td>
                                        <td><?php echo $vehicle->remark; ?></td>
                                         <td><a href="<?php echo base_url();?>transport/travel/index_vehicle_service?transdel=<?php echo $vehicle->id;?>" onclick="javascript: return confirm('Are you sure you want to delete this');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>                                         
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('transport/travel/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="vehicle_no"  id="number"  placeholder="<?php echo $this->lang->line('vehicle'); ?> <?php echo $this->lang->line('number'); ?>" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="start_km"  id="start_km" value="<?php echo isset($post['start_km']) ?  $post['start_km'] : ''; ?>" placeholder="Start km" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="end_km"  id="end_km" value="<?php echo isset($post['end_km']) ?  $post['end_km'] : ''; ?>" placeholder="End km" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('end_km'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Total km <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="total_distance"  id="total" value="<?php echo isset($post['total_distance']) ?  $post['total_distance'] : ''; ?>" placeholder="Total distance" required="required" type="text" readonly>
                                        <div class="help-block"><?php echo form_error('total_distance'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Today's Date <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="created_at"  id="created_at" value="<?php echo isset($post['created_at']) ?  $post['created_at'] : ''; ?>" placeholder="Created at" required="required" type="date">
                                        <div class="help-block"><?php echo form_error('created_at'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Cash<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="cash"  id="total" value="<?php echo isset($post['cash']) ?  $post['cash'] : ''; ?>" placeholder="Total distance" required="required" type="text" >
                                        <div class="help-block"><?php echo form_error('cash'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Deisel <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="diesel"  id="created_at" value="<?php echo isset($post['diesel']) ?  $post['diesel'] : ''; ?>" placeholder="Created at" required="required" type="text">
