...
<li  class="active"><a href="#tab_add_vehicle"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> Transport</a> </li>                          
                       
                    </ul>
                    <br/>
                    
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_vehicle_list" >
                            <div class="x_content">
                            <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <button class="btn btn-success" type="button" id="button_vehicle" onclick="get_date_changer();">Find</button>
                        ...
                        <div  class="tab-pane fade in active" id="tab_add_vehicle">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('transport/travel/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="vehicle_no" id="number" class="form-control col-md-7 col-xs-12" required="required">
                                            <option value="">--select--</option>
                                            <?php 
                                            $vehicles = $this->db->get_where('vehicles')->result();
                                                 foreach ($vehicles as $vehi) {
                                                  ?>
                                                   <option value="<?php echo $vehi->number;?>" <?php echo isset($post['number']) && $vehi->number == $vehi->number ?  'selected' : ''; ?>><?php echo $vehi->number;?>
                                                   </option>
                                                <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="vehicle_id" class="form-control col-md-7 col-xs-12" >
                                            <option value="">--select--</option>
                                            <?php 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Start km <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12 calc"  name="start_km"  id="start_km" value="<?php echo isset($post['start_km']) ?  $post['start_km'] : ''; ?>" placeholder="Start km" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('start_km'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">End km <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12 calc"  name="end_km"  id="end_km" value="<?php echo isset($post['end_km']) ?  $post['end_km'] : ''; ?>" placeholder="End km" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('end_km'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Total Travelled <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="total_distance"  id="total" value="<?php echo isset($post['total_distance']) ?  $post['total_distance'] : ''; ?>" placeholder="Total Travelled" required="required" type="text" readonly>
                                        <div class="help-block"><?php echo form_error('total_distance'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact"> Date <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="created_at"  data-format="yyyy-mm-dd" id="created_at" value="<?php echo isset($post['created_at']) ?  $post['created_at'] : ''; ?>" placeholder="Date" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('created_at'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Total payment<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="cash"  id="total" value="<?php echo isset($post['cash']) ?  $post['cash'] : ''; ?>" placeholder="Total payment" required="required" type="text" >
                                        <div class="help-block"><?php echo form_error('cash'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Advance payment <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="advanced_payment"  id="created_at" value="<?php echo isset($post['advanced_payment']) ?  $post['advanced_payment'] : '0'; ?>" placeholder="Advanced Payment" type="number">
                                        <div class="help-block"><?php echo form_error('advanced_payment'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Quantity of Fuel <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="diesel"  id="created_at" value="<?php echo isset($post['diesel']) ?  $post['diesel'] : ''; ?>" placeholder="Quantity of Fuel" required="required" type="number">
                                        <div class="help-block"><?php echo form_error('diesel'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Commodity type <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select name="inventory_type" class="form-control col-md-7 col-xs-12" required>
                                            <option value="">--select--</option>
                                            <option value="1">Diesel</option>
                                            <option value="2">Mobil Oil</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Filled at <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select name="usage_location" class="form-control col-md-7 col-xs-12" required>
                                            <option value="">--select--</option>
                                ...
                                <!--<div class="item form-group">-->
                                <!--    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Cost given for vehicle repairing <span class="required">*</span>-->
                                <!--    </label>-->
                                <!--    <div class="col-md-6 col-sm-6 col-xs-12">-->
                                <!--        <input  class="form-control col-md-7 col-xs-12"  name="vehicle_repairing"  id="created_at" value="<?php echo isset($post['vehicle_repairing']) ?  $post['vehicle_repairing'] : ''; ?>" placeholder="Cost given for vehicle repairing" type="text">-->
                                <!--        <div class="help-block"><?php echo form_error('vehicle_repairing'); ?></div>-->
                                <!--    </div>-->
                                <!--</div>-->
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact">Note
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea class="form-control col-md-7 col-xs-12"  name="vehicle_damage"><?php echo isset($post['vehicle_damage']) ?  $post['vehicle_damage'] : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('vehicle_damage'); ?></div>
                                    </div>
                                </div>
...
<div class="map-container">
 ...
 $(document).ready(function(){
     $('#created_at').datepicker({format: 'yyyy-mm-dd'});
 });
...
<script>
    $('.calc').on('keyup',function (){
        var startkm = parseFloat($('#start_km').val());
        var endkm = parseFloat($('#end_km').val());
        if(startkm && endkm){
            $('#total').val((endkm-startkm));
        }else {
            $('#total').val(0);
        }
    })
