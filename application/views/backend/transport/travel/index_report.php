            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class=""><a href="<?php echo site_url(); ?>admin/manage_transport_report"   ><?php echo $this->lang->line('transport'); ?> <?php echo $this->lang->line('report'); ?></a> </li>
...
<script type="text/javascript">
	function get_date_changer()
	{
	    ...
	    //alert(val);
		$.ajax({
            url: '<?php echo base_url();?>transport/travel/get_date_data_report',
            data : { dated : val},
            type: 'POST',
            success: function(response)
            {
