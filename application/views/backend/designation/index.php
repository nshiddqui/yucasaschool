            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_designation_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="entypo-menu"></i> <?php echo $this->lang->line('designation'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'hrm', 'designation')){ ?>
                            <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_designation"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="entypo-plus-circled"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('designation'); ?></a> </li>                          
                        <?php } ?> 
                        <?php if(isset($edit)){ ?>
                    ...
                    <div class="tab-content">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap datatable" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="max-width:150px;"><?php echo $this->lang->line('note'); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- <?php if(has_permission(EDIT, 'hrm', 'designation')){ ?>
                                                    <a href="<?php echo site_url('designation/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'hrm', 'designation')){ ?>
                                                    <a href="<?php echo site_url('designation/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?> -->
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        ...
                                                        <li>
                                                           <?php if(has_permission(EDIT, 'hrm', 'designation')){ ?>
                                                                <a href="<?php echo site_url('designation/edit/'.$obj->id); ?>" class=""><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                            <?php } ?>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <?php if(has_permission(DELETE, 'hrm', 'designation')){ ?>
                                                            <a href="<?php echo site_url('designation/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class=""><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                        <?php } ?>
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_designation">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('designation/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a  href="<?php echo site_url('designation'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_designation">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('designation/edit/'.$designation->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo $this->lang->line('designation'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
