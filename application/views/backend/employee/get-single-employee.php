                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($employee->resume){ ?>
                                <a href="<?php echo UPLOAD_PATH; ?>/employee-resume/<?php echo $employee->resume; ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i> <?php echo $this->lang->line('download'); ?></a>
                            <?php } ?>
                        </td>
                    </tr>                    
