   ...
   <div class="page-header">
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
        ...
        <li class="active">Due Fee SMS</li>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('due_fee'); ?> <?php echo $this->lang->line('sms'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'accounting', 'duefeesms')){ ?>
                                                    <a  onclick="showAjaxModal('<?php echo site_url('modal/popup/get-single-sms/'.$obj->id);?>');"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'accounting', 'duefeesms')){ ?>     
                                                    <a href="<?php echo site_url('duefeesms/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_sms">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('duefeesms/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select  class="form-control col-md-12 col-xs-12"  name="sms_gateway"  id="sms_gateway" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option><?php foreach($services AS $key=>$value){ ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  id="fn_tag" style="padding-top: 6px;">[name] [email] [phone] [due_amount]</div>
                                </div> 
                                <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('accounting/duefeesms/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
