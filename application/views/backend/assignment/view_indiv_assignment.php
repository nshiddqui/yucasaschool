            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    <div class="tab-content">
                        <div  >
                            <div class="x_content">
                               <?php echo form_open_multipart(site_url('assignment/view_indiv_assignment/filter/'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                             ...
                             <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 quick-field"  name="student_id" onchange="get_subject_list_by('',this.value, false);" id="add_student_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                      
                                        </select>
                                        <a href="<?php echo site_url('academic/subject/add'); ?>" class="btn btn-success btn-md quick-add">+</a>
                                ...
                                <tbody> 
                                    ...
                                    <?php $count = 1; if(isset($filter_assignments) && !empty($filter_assignments)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $this->db->get_where('subject',array('subject_id'=>$obj->subject_id))->row()->name; ?></td>
                                            ...
                                            <td><a href="<?php echo base_url();?>assets/uploads/assignment/<?php echo $obj->assignment;?>" download>Download</a></td>
                                            <td><?php echo $obj->assignment_marks; ?></td>
                                            </tr>
                                            <?php }
                                            }?>
                                            </tbody>
...
//alert(class_id);
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_section_by_subjects_students'); ?>",
               ...
               if(response)
               {
                   if(is_edit){
                       var res = response.split("~#~");
                        $('#edit_subject_id').html(res[0]);
                        $('#edit_student_id').html(res[1]);
                   }else{
                       var res = response.split("~#~");
                        $('#add_subject_id').html(res[0]);
                        $('#add_student_id').html(res[1]);
                   }
               }
            }
        });                  
