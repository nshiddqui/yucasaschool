            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="<?php echo site_url('member/index/'); ?>"   aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('designation_users/member'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'hostel', 'member')){ ?>
                            <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('designation_users/add/'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('non_member'); ?> <?php echo $this->lang->line('list'); ?></a> </li>                          
                        <?php } ?>
                    </ul>
                    <br/>
                                    ...
                                    <?php $count = 1; if(isset($members) && !empty($members)){ ?>
                                        ...
                                        <tr>
                                           ...
                                           <td><img src="<?php echo $this->crud_model->get_image_url('student',$obj->student_id);?>" class="img-circle" width="30" /></td>
                                            ...
                                            <td><?php //echo $this->gsms_setting->currency_symbol; ?> <?php echo $obj->cost; ?></td>
                                            <td>
                                                <?php if(has_permission(DELETE, 'hostel', 'member')){ ?>
                                                    <a href="<?php echo site_url('member/delete/'.$obj->hm_id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php $count = 1; if(isset($non_members) && !empty($non_members)){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $obj->student_code; ?></td>
                                        <td>
                                            <select  class="form-control col-md-7 col-xs-12 alignleft" name="hostel_id" id="hostel_id_<?php echo $obj->student_id; ?>" onchange="get_room_by_hostel(this.value, '<?php echo $obj->student_id; ?>');" required="required">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12" name="room_id" id="room_id_<?php echo $obj->student_id; ?>" required="required">
