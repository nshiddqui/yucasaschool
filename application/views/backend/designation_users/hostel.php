                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_hostel">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('designation_users/hostal_add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_hostel">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('designation_users/hostel_edit/'.$hostel->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
