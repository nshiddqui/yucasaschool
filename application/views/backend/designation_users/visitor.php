                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($visitors) && !empty($visitors)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php $user = get_user_by_role($obj->role_id, $obj->user_id); echo $user->name; ?><br/>(<?php echo $obj->role; ?>)
                                            </td>
                                               ...
                                               <!--  <?php if(has_permission(EDIT, 'visitor', 'visitor')){ ?>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        ...
                                                        <li>
                                                          <?php if(has_permission(EDIT, 'visitor', 'visitor')){ ?>
                                                            <a href="<?php echo site_url('visitor/edit/'.$obj->id); ?>" class=""><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        </li>

                                                       <!--  <li>
                                                             <?php if(has_permission(VIEW, 'visitor', 'visitor')){ ?>
                                                            <a  onclick="get_visitor_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-visitor-modal-lg"  class=""><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                        <?php } ?>
                                                        </li> -->
                                                        ...
                                                        <li>
                                                           <?php if(has_permission(DELETE, 'visitor', 'visitor')){ ?>
                                                                <a href="<?php echo site_url('visitor/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class=""><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                            <?php } ?>
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_visitor">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('designation_users/visitor_add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="coming_from"  id="coming_from" value="<?php echo isset($post['coming_from']) ?  $post['coming_from'] : ''; ?>" placeholder="<?php echo $this->lang->line('coming_from'); ?>" required="required" type="text">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('visitor/edit'), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($visitor->name) ?  $visitor->name : $post['name']; ?>" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($visitor->phone) ?  $visitor->phone : $post['phone']; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('phone'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="coming_from"  id="coming_from" value="<?php echo isset($visitor->coming_from) ?  $visitor->coming_from : $post['coming_from']; ?>" placeholder="<?php echo $this->lang->line('coming_from'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('coming_from'); ?></div>
                                    </div>
                                </div>
