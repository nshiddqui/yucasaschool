                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <!--  <a  onclick="get_employee_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-employee-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a> -->
                                                ...
                                                <a  onclick='showAjaxModal("http://desktop-22kuple/edurama_full/index.php/modal/popup/get-single-employee/<?php echo $obj->id; ?>");'  class=""><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                ...
                                                <?php } ?>
                                                        ...
                                                        <li>
                                                             <?php if(has_permission(DELETE, 'hrm', 'employee')){ ?> 
                                                                <?php if($obj->id != 1){ ?> 
                                                                    <a href="<?php echo site_url('employee/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class=""><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </li>
                                                    </ul>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_employee">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('employee/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
