        ...
        <div class="" data-example-id="togglable-tabs">
          ...
          <div class="tab-content">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <!-- <th><?php echo $this->lang->line('hostel_id'); ?></th> -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><!-- <?php if(has_permission(EDIT, 'hostel', 'hostel')){ ?>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            <li>
                              ...
                              <a href="<?php echo site_url('hostel/edit/'.$obj->id); ?>" class=""><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                              <?php } ?>
                            </li>
                            <li class="divider"></li>
                            <li>
                              <?php if(has_permission(DELETE, 'hostel', 'hostel')){ ?>
                              <a href="<?php echo site_url('hostel/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class=""><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                              <?php } ?>
                            </li>
                          </ul>
                        </div></td>
            ...
            <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_hostel">
              <div class="x_content"> <?php echo form_open(site_url('hostel/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo $this->lang->line('hostel'); ?> <?php echo $this->lang->line('name'); ?> <span class="required">*</span> </label>
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select  class="form-control col-md-7 col-xs-12" name="type" id="type" required>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-md-offset-3"> <a href="<?php echo site_url('hostel'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
            ...
            <div class="tab-pane fade in active" id="tab_edit_hostel">
              <div class="x_content"> <?php echo form_open(site_url('hostel/edit/'.$hostel->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo $this->lang->line('hostel'); ?> <?php echo $this->lang->line('name'); ?> <span class="required">*</span> </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
