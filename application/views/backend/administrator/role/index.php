                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($roles) && !empty($roles)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->is_default ? $this->lang->line('yes') : $this->lang->line('no'); ?>
                                                
                                            </td>
                                            <!-- <td>
                                                <?php if(has_permission(EDIT, 'administrator', 'role')){ ?>
                                                    <a href="<?php echo site_url('administrator/role/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'role')){ ?>
                                                    <?php if(!$obj->is_default){ ?>
                                                        <a href="<?php echo site_url('administrator/role/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    <?php } ?>
                                                <?php } ?>
                                            </td> -->
                                        </tr>
                               ...
                               <?php echo form_open(site_url('administrator/role/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($name) ?  $name : ''; ?>" placeholder="<?php echo $this->lang->line('role'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text">
                               ...
                               <?php echo form_open(site_url('administrator/role/edit'), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input  class="form-control col-md-7 col-xs-12"  name="name" value="<?php echo isset($role) ? $role->name : ''; ?>"  placeholder="<?php echo $this->lang->line('role'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
