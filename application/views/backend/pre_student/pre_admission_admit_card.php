...
<?php
    ...
    $online_exam   = $this->db->get_where('pre_online_exam',array('class_id'=>$class_id->class_id,'running_year'=>$this->year))->row();
		...
		<!-- <ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('pre_exam_list');?>
                    	</a></li>
		</ul> -->
    	<!------CONTROL TABS END------>
		<div class="tab-content"><div class=" " id="admit_card">
        ...
        <div class="col-md-9 p0">
            <table class="col-md-12">
                <tr>
                    ...
                    <td class="admit_value"><?php if($online_exam->exam_date != ""){  echo date('D , d , F,Y',$online_exam->exam_date);}?></td>
                </tr>
                <tr>
                    <td class="admit_label">Test Time/Session</td>
                    <td class="admit_value"><?php if($online_exam->time_start != ""){  echo date('H:i a',strtotime($online_exam->time_start));}?>  -  <?php if($online_exam->time_end != ""){  echo date('H:i a',strtotime($online_exam->time_end));}?></td>
                </tr>
                <tr>
