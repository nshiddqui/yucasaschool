            ...
            <tbody>
            	<?php
                    ...
                    <tr>
                    	...
                    	<td>
							<?php if ($this->pre_exam_modal->check_availability_for_student($row['online_exam_id']) != "submitted"): ?>
								<?php if ($current_time >= $exam_start_time && $current_time <= $exam_end_time): ?>
									<a href="<?php echo site_url('pre_student/take_online_exam/'.$row['code']);?>" class="btn btn-success">
