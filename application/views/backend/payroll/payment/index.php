                                                ...
                                                <?php } ?> -->
                                                 ...
                                                 <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        ...
                                                        <li>
                                                             <?php if(has_permission(VIEW, 'payroll', 'payment')){ ?>
													 <a href="javascript:void(0);" class="btn btn-success btn-xs" onclick='showAjaxModal("https://edurama.in/unityerp/modal/popup/get-single-payment/<?php echo $obj->id; ?>/<?=$obj->payment_to; ?>");'><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                        ...
                        <?php if(isset($payment)){ ?>
                            <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_payment">
                                ...
                                <div class="x_content"> 
                                   ...
                                   <?php  $gross_salary=$payment->gross_salary ; 
								    $perday=$gross_salary/30;
								 $teacher_id=$payment->teacher_id  ;
								 $query = $this->db->query("SELECT * FROM emp_attendance where emp_id='$teacher_id'");
 $leaveday=$query->num_rows();
  $totalsalary=$perday *$leaveday; 
  $attendence_deduction=$gross_salary -$totalsalary;
 ?>
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                        ...
                                        <?php if($payment->salary_type == 'monthly'){ ?>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
											    ...
											    <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="attendance_deduction">Attendance Deduction </label>
                                                    <input  class="form-control col-md-7 col-xs-12 "  name="attendance_deduction"  id="add_attendance_deduction" value="<?php echo $attendence_deduction; ?>" placeholder="Attendance Deduction" readonly="readonly" type="number">
                                                    <div class="help-block"><?php echo form_error('attendance_deduction'); ?></div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <input type="hidden" id="edit_user_id" name="user_id" value="<?php echo $edit_payment->user_id ?>" />
                                            ...
                                            <a href="<?php echo site_url('payroll/payment'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
 ...
 <script type="text/javascript">
    ...
    $('.fn_add_claculate').on('keyup', function(){
        ...
        if(type === 'monthly'){
            ...
            var attendance_deduction = $('#add_attendance_deduction').val() ? parseFloat($('#add_attendance_deduction').val()) : 0;
           ...
           $('#add_total_allowance').val(house_rent+transport+medical+bonus+ot_total_amount);       
            ...
            $('#add_total_deduction').val(provident_fund+penalty+attendance_deduction);
