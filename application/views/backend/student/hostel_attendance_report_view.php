...
<?php if ($hostel_id != '' && $month != '' && $sessional_year != '' && $student_id != ''): ?>
        ...
        <div class="col-md-4" style="text-align: center;">
            <div class="tile-stats tile-gray">
                ...
                <h4 style="color: #696969;">
                    <?php echo get_phrase('hostel');?> <?php echo $hostel_name; ?><br>
        ...
        <div class="col-md-12">
            <table class="table table-bordered" id="my_table">
                ...
                <tbody>
                        <?php
                            $data = array();
                           // $hosteldetails = $this->db->get_where('hostel_attendance', array('hostel_id' => $hostel_id, 'year' => $running_year, 'student_id' => $student_id))->result_array();
    ...
    <?php ?>
            ...
            <center>
                <a href="<?php echo base_url(); ?>index.php/student/hostel_attendance_report_print_view/<?php echo $hostel_id; ?>/<?php echo $month; ?>/<?php echo $sessional_year; ?>/<?php echo $student_id; ?>"
