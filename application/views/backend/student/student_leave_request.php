...
<?php include base_path().'application/views/backend/navigation_tab/student/student_nav_tab.php'; ?> 
<!-- Including Navigation Tab -->
</div>
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('student/student_leave_request/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('id_no');?></label>

						<div class="col-sm-5">
							<input type="text" class="form-control" name="student_code" value="<?php echo $student_code; ?>" data-validate="required" id="class_id"
