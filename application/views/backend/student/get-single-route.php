<?php  
    ...
    $route       = $this->db->get_where('routes', array('id' => $param2))->row();

    $route_stops = $this->db->get_where('route_stops', array('route_id'=>$route->id))->result();
            ...
            <td>
                <table style="width:100%;" class="fn_edit_stop_container responsive"> 
                    ...
                    <?php foreach($route_stops as $obj){ ?> 
                        <tr style="<?php if($param3 == $obj->id){?>color:red; <?php }?>" >  
