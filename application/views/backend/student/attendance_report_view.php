...
<?php if ($class_id != '' && $section_id != '' && $month != '' && $sessional_year != '' && $student_id != ''): ?>
            ...
            <table class="table table-bordered" id="my_table">
                <thead>
                    <tr>
                        ...
                        echo $days = cal_days_in_month(CAL_GREGORIAN, $month, $sessional_year);
                        for ($i = 1; $i <= $days; $i++) {
                            ?>
  ...
  <?php endif; ?>
    ...
    <?php ?>
            ...
            <center>
                <a href="<?php echo base_url(); ?>index.php/student/attendance_report_print_view/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $month; ?>/<?php echo $sessional_year; ?>/<?php echo $student_id; ?>"
