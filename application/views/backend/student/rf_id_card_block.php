<?php   $route = $this->db->get_where('student', array('student_id' => logged_in_user_id()))->row();
        $route_stops = $this->db->get_where('enroll', array('student_id' => logged_in_user_id()))->row();
