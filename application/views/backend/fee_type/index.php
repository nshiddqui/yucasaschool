                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                                 ...
                                                 <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a onclick='showAjaxModal("<?php echo site_url('modal/popup/get-single-feetype/'.$obj->id); ?>     http://desktop-22kuple/edurama_full/index.php/modal/popup/get-single-feetype/<?php echo $obj->id; ?>");' class=""><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                            </a>
                                                             </li>
                                                        <?php  } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_feetype">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('feetype/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_feetype">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('feetype/edit/'.$feetype->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
