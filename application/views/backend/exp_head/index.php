                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>   
                                                <?php if(has_permission(EDIT, 'accounting', 'exphead')){ ?>
                                                    <a href="<?php echo site_url('exphead/edit/'.$obj->id); ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'accounting', 'exphead')){ ?>
                                                    <a href="<?php echo site_url('exphead/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_exphead">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exphead/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_exphead">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exphead/edit/'.$exphead->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
