...
<div class="mail-env">
    ...
    <div class="mail-sidebar">
        ...
        <div class="mail-sidebar-row">
            <a href="<?php echo site_url('teacher/message/message_new'); ?>" class="btn btn-success btn-block">
        ...
        <ul class="mail-menu">
            ...
            foreach ($message_threads as $row):
                ...
                <li class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active'; ?>">
                    <a href="<?php echo site_url('teacher/message/message_read/'.$row['message_thread_code']); ?>/<?php echo $user_to_show_type; ?>/<?php echo $user_to_show_id; ?>" style="padding:12px;">
