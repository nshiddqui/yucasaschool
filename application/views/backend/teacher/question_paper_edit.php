        ...
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open(site_url('admin/question_paper/update/'. $param2 ), array('class' => 'form-horizontal form-groups-bordered validate',
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control" name="password" data-validate="required" data-message-required="Value Required" value="<?php echo $row['password']; ?>" autofocus="">
                        </div>
                        </div>
