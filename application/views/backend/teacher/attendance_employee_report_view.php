        ...
        <label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('Designation');?></label>
            <select name="class_id" class="form-control selectboxit" onchange="select_section(this.value)" id = "class_selection">
                ...
                <option value="<?php echo $row['id'];?>"
                    <?php if ($row['id'] == $class_id) echo 'selected'; ?> 
...
<?php if ($class_id != '' && $month != '' && $sessional_year != ''): ?>
...
<script type="text/javascript">
   ...
   $('.closePopup').click(()=> $('.attendancePopup').hide());
    ...
    $.ajax({
        ...
        type: "POST",
        data: {'class_id':"<?php echo $class_id;?>",'month':"<?php echo $month;?>",'sessional_year':"<?php echo $sessional_year;?>"},
