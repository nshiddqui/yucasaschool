			...
			<table class="table table-bordered">
				...
				?>
					<tr>
						...
						<td>
							<input type="text" class="form-control" name="max_marks_<?php echo $row['mark_id'];?>"
						...
						<?php } ?>
							...
							<td data-src="<?php echo $row['grade_id'];?>">
							    <select name="grade_id_<?php echo $row['mark_id'];?>" class="form-control" <?php if($marks_editable==0){?>disabled<?php } ?>>
							        <option>--SELECT GRADE--</option> 
							        <?php	foreach($grades as $grade) { 	?>
							        <option value="<?php echo $grade['grade_id'];?>" <?php if($row['grade_id']==$grade['grade_id']){ echo "selected";}?>><?php echo $grade['name'];?></option> 
							        <?php } ?>
							        </select>
							</td>
