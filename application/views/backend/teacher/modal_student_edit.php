			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/student/do_update/'.$row['student_id'].'/'.$row['class_id'])  , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <select name="section_id" class="form-control selectboxit" onchange="get_edit_autogenrate_roll(this.value,'<?php echo $param2;?>','<?php echo $row['section_id'];?>');">
               ...
               <div class="form-group">
                ...
                <?php }
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="hostel_id" class="form-control selectboxit" onchange="get_room_by_hostel(this.value,'edit');">
                              <option value=""><?php echo get_phrase('select');?></option>
	                            <?php
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="transport_id" class="form-control selectboxit" onchange = "transportroute(this.value,'edit');">
                              <option value=""><?php echo get_phrase('select');?></option>
                              <?php
