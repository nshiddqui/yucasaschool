...
class Textlocalsms
{
	...
	public function sendSms($numbers, $message, $sender = null, $sched = null, $test = false, $receiptURL = null, $custom = null, $optouts = false, $simpleReplyService = false)
	{
		...
		$params = array(
			...
			'sender'        => rawurlencode($this->sender_id),
			'schedule_time' => $sched,
			'test'          => $test,
